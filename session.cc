...
Session::Session(): Module("session") 
{
 ...
 AssignParameter("pressfactor", "160217.66");     // Conversion: 1 (ev/(angstrom^3)) = PRESSFACTOR (MPa)
 AssignParameter("ua3togrcm3", "1.6605i39");         // Conversion: 1 uma/A^3 = Ua3ToGRcm3
 AssignParameter("q2a2force", "0.13893546");      // Conversion: 1 (qe*qe/angstrom*angstrom) = Q2a2FORCE (uma * angstrom / (fs^2))
 AssignParameter("q2a2ev", "14.399645");            // Conversion: 1 (qe*qe/(angstrom)) = Q2a2EV (eV)
}

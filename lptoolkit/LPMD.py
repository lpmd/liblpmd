...
import sys, ctypes
sys.path.insert(0, os.path.join('/home/jperaltac/local', 'lib'))
...
def __initLPMD__():
    ...
    lpmd_lib = ctypes.CDLL(os.path.join(os.path.join('/home/jperaltac/local', 'lib'), 'liblpmd.so.3'), ctypes.RTLD_GLOBAL)
    globaltags = dict()
